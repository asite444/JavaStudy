...
public class AgeSort {
	...
	public static Comparator<Member> compAge =new Comparator<Member>() {
		
		@Override
		public int compare(Member o1, Member o2) {
			int result;
			if(o1.age==o2.age) result=o1.seqNumb-o2.seqNumb;
			else result=o1.age-o2.age;
			return result;
		}
	};
...
class Member {
	...
	public Member(int age,String name,int seqNumb) {
	this.age=age;
	this.name=name;
